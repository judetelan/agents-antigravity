---
description: Workflow for Implement comprehensive security hardening with defense-in-depth strategy through coordinated multi-agent orchestration:. Invoke with /security-hardening command.
---
