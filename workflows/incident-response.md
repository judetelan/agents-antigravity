---
description: Workflow for Orchestrate multi-agent incident response with modern SRE practices for rapid resolution and learning:. Invoke with /incident-response command.
---
